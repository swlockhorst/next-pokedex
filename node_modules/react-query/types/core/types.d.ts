...
export declare type QueryFunction<T = unknown> = (context: QueryFunctionContext<any>) => T | Promise<T>;
...
export declare type QueryKeyHashFunction = (queryKey: QueryKey) => string;
...
export interface QueryObserverOptions<TQueryFnData = unknown, TError = unknown, TData = TQueryFnData, TQueryData = TQueryFnData> extends QueryOptions<TQueryFnData, TError, TData> {
    /**
...
export interface InfiniteQueryObserverOptions<TQueryFnData = unknown, TError = unknown, TData = TQueryFnData, TQueryData = TQueryFnData> extends QueryObserverOptions<TQueryFnData, TError, InfiniteData<TData>, InfiniteData<TQueryData>> {
}
export interface FetchQueryOptions<TQueryFnData = unknown, TError = unknown, TData = TQueryFnData> extends QueryOptions<TQueryFnData, TError, TData> {
    /**
     * The time in milliseconds after data is considered stale.
...
export interface FetchInfiniteQueryOptions<TQueryFnData = unknown, TError = unknown, TData = TQueryFnData> extends FetchQueryOptions<TQueryFnData, TError, InfiniteData<TData>> {
}
...
export declare type MutationKey = string | unknown[];
